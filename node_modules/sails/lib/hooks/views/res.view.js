...
var viewFailedToRender = function (err, renderedViewStr) {
// Prevent endless recursion:
...
var expressResRender = require('express/lib/response').render;
var layoutRender = function(view, locals, fn) {
locals = locals || {};
var self = this, cb;
// default callback to respond
fn = fn || viewFailedToRender;
if (layout) {
cb = function(err, str) {
if (err) return req.next(err);
locals.body = str;
res.render(layout, locals, fn);
};
} else {
cb = fn;
}
// render
expressResRender.call(res, view, locals, cb);
};
return layoutRender(relPathToView, locals);
};
next();
};
