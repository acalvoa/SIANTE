...
function processStyleUrl(node) {
  ...
  var createInfoWindow = function(placemark, doc, gObj) {
    ...
    var temp = JSON.parse(JSON.stringify(vars.val));
    delete temp.name;
    ...
    // var iwText = bStyle.text.replace(/\$\[(\w+(\/displayName)?)\]/g, function(txt, n, dn) { 7
        
    //     return dn ? vars.display[n] : vars.val[n]; 
    // });
    var tdata = "<table>";
    for(key in temp){
      var trow = "<tr><td>"+key+"</td><td>&nbsp;&nbsp;&nbsp;</td><td>"+temp[key]+"</td></tr>";
      tdata = tdata+trow;
    }
    tdata = tdata + "</table>";
    var iwText = tdata;
